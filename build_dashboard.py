    ...
    <div class="table-container" id="tableContainer">
        <table id="mainTable">
            <thead>
                <tr>
                    <th>Disease Name</th>
                    <th>Clinical Criteria <br><span style="opacity:0.6; font-weight:400">臨床條件</span></th>
                    <th>Lab Criteria <br><span style="opacity:0.6; font-weight:400">檢驗條件</span></th>
                    <th>Epidemiology Criteria<br><span style="opacity:0.6; font-weight:400">流行病學條件</span></th>
                    <th>Reporting Criteria<br><span style="opacity:0.6; font-weight:400">通報定義</span></th>
                    <th>Case Classification <br><span style="opacity:0.6; font-weight:400">疾病分類</span></th>
                    <th>Specimen Sampling<br><span style="opacity:0.6; font-weight:400">檢體採檢送驗事項</span></th>
                </tr>
            </thead>
            <tbody id="tableBody">
                <!-- Rows -->
